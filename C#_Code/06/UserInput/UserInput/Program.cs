    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            /*
            //提示用户依次输入姓名, 性别, 年龄, 然后最后打印出用户输入的信息
            string name;
            string gender;
            string age;
            ...
            //\b : 表示一个BackSpace 退格键, 会把前面的一个字符删除
             ...
             *   2. 将字符串按照原格式输出
             */
            string path = @"C:\Users\fcrit\Desktop\C#_Code\06";
            Console.WriteLine(path);

            //输入是什么, 输出就是什么(对win10无效)
            Console.WriteLine(@"我的名字 叫 M  o   n  k e y");
